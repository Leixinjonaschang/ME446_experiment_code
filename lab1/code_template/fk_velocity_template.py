...
class FKVelocityExercise:
    ...
    def compute_ee_velocity(self, q, q_dot):
        ...
        # TODO: EXERCISE: 4. Calculate current end-effector pose T for COM position
        # Use the Product of Exponentials formula: T = e^[S1]q1 * e^[S2]q2 * ... * e^[Sn]qn * M
        # Hint: Similar to forward_kinematics_poe, iterate through joints and multiply transformations
        T = np.eye(4)  # Replace with your implementation
        p_com = np.zeros(3)  # Replace with your implementation
        
        # TODO: EXERCISE: 5. Compute linear velocity at the COM point
        # The spatial velocity v_s is the velocity of a point at the origin.
        # For a point p on the body, we use: v_point = v_s + omega_s × p
        linear_vel_com = np.zeros(3)  # Replace with your implementation
