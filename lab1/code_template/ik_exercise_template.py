...
class PandaIKSolver:
    ...
    def _loss_function(self, q, target_pos, target_quat_scipy):
        ...
        # TODO: 1. Get current end effector pose
        curr_pos, curr_quat_mj = None, None # Replace with your implementation
        
        # TODO: 2. Compute Position Error (Vector difference)
        pos_err = None # Replace with your implementation
        
        # TODO: 3. Compute Orientation Error
        # Convert MuJoCo [w, x, y, z] to Scipy [x, y, z, w] in NumPy array format
        curr_quat_scipy = None # Replace with your implementation
        
        #  TODO: 4. Convert the current and target quaternions to rotation matrices, why?
        rot_curr = None # Replace with your implementation
        rot_target = None # Replace with your implementation
        
        # TODO: 5. Compute the rotation difference: R_diff = R_target * R_curr^T
        # We want the magnitude of the rotation vector of R_diff to be 0
        rot_diff = None # Replace with your implementation
