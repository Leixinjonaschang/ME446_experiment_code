...
class PandaIKSolver:
    ...
    def _loss_function(self, q, target_pos, target_quat_scipy):
        ...
        #TODO: Compute Position error and orientation error
        # You can refer to lab 1 code.
        pos_err = None # replace None with your implementation
        ori_err = None # replace None with your implementation
    ...
    def solve(self, target_pos, target_quat_scipy, q_guess):
        ...
        # TODO: use least_squares to solve IK, you can refer to lab 1 IK template code.
        result = None # replace None with your implementation
        return result.x
...
def compute_joint_pd_control(data, q_target, kp, kd):
    ...
    # TODO: implement the PD control law
    q_err = None # replace None with your implementation
    v_err = None # replace None with your implementation
    
    torque = None # replace None with your implementation
